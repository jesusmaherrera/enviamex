...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.tipo'
        db.add_column('envios_cliente', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.tipo'
        db.delete_column('envios_cliente', 'tipo')
    ...
    models = {
        ...
        'envios.envio': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['envios.Cliente']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
