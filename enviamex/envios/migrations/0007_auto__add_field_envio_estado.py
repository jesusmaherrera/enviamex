...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Envio.estado'
        db.add_column('envios_envio', 'estado',
                      self.gf('django.db.models.fields.CharField')(default='PE', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Envio.estado'
        db.delete_column('envios_envio', 'estado')
